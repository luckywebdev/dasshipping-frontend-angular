...
import { ChangesCarrierInviteComponent } from './changes-carrier-invite.component';

describe('ChangesCarrierInviteComponent', () => {
  let component: ChangesCarrierInviteComponent;
  let fixture: ComponentFixture<ChangesCarrierInviteComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [RegisterCarrierComponent, ChangesCarrierInviteComponent, RegisterCarrierFinishComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ChangesCarrierInviteComponent);
